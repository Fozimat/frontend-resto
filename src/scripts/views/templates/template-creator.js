...
<img class="restaurant__poster lazyload" crossorigin="anonymous" data-src="${
...
<div class="row">
  <div div class="column">
    <h3 class="foods" tabindex="0">Foods (${
  ...
  <div class="column">
    <h3 tabindex="0" class="drinks" tabindex="0">Drinks (${
...
<div class="restaurant__review">
  <h3 tabindex="0">Customer Reviews (${
...
function createRestaurantsTemplate(restaurants) {
  return `
    ...
    <div class="post-header">
        ...
        <img class="post-item__thumbnail lazyload" crossorigin="anonymous" data-src="${
          CONFIG.BASE_IMAGE_URL + restaurants.pictureId
        }" alt="${restaurants.name}">
        <div class="post-item__content">
            <h1 class="post-item__title"><a href="${`/#/detail/${restaurants.id}`}">${
    restaurants.name
  }</a></h1>
